export default function Loader() {
  return (
    <div className="flex items-center justify-center py-16">
      {/* CSS inject — no extra dependency needed */}
      <style>{`
        .loader {
          width: fit-content;
          height: fit-content;
      ...
      <div className="loader">
        <div className="truckWrapper">
          ...
          {/* Road + Lamp */}
          <div className="road" />
          <svg xmlSpace="preserve" viewBox="0 0 453.459 453.459" xmlnsXlink="http://www.w3.org/1999/xlink"
               xmlns="http://www.w3.org/2000/svg" version="1.1" fill="#000000" className="lampPost">
